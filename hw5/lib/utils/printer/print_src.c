...
void printA_Stm(FILE *out, A_stm s) {
  ...
  switch (s->kind) {
  case A_nestedStm:
    printA_NestedStm(out, s);
    break;
  case A_ifStm:
    printA_IfStm(out, s);
    break;
  case A_whileStm:
    printA_WhileStm(out, s);
    break;
  case A_assignStm:
    printA_AssignStm(out, s);
    break;
  case A_arrayInit:
    printA_ArrayInit(out, s);
    break;
  case A_callStm:
    printA_CallStm(out, s);
    break;
  case A_continue:
    printA_Continue(out, s);
    break;
  case A_break:
    printA_Break(out, s);
    break;
  ...
  case A_putnum:
    ...
    break;
  case A_putarray:
    printA_Putarray(out, s);
    break;
  case A_putch:
    printA_Putch(out, s);
    break;
  case A_starttime:
    printA_Starttime(out, s);
    break;
  case A_stoptime:
    printA_Stoptime(out, s);
    break;
  default:
...
/* */
void printA_Putnum(FILE *out, A_stm s) {
#ifdef __DEBUG
...
void printA_Exp(FILE *out, A_exp e) {
  ...
  case A_opExp:
    ...
    break;
  case A_arrayExp:
    printA_ArrayExp(out, e);
    break;
  case A_callExp:
    printA_CallExp(out, e);
    break;
  case A_classVarExp:
    printA_ClassVarExp(out, e);
    break;
  case A_boolConst:
    printA_BoolConst(out, e);
    break;
  case A_numConst:
    printA_NumConst(out, e);
    break;
  case A_lengthExp:
    printA_LengthExp(out, e);
    break;
  case A_idExp:
    printA_IdExp(out, e);
    break;
  case A_thisExp:
    printA_ThisExp(out, e);
    break;
  case A_newIntArrExp:
    printA_NewIntArrExp(out, e);
    break;
  case A_newFloatArrExp:
    printA_NewFloatArrExp(out, e);
    break;
  case A_newObjExp:
    printA_NewObjExp(out, e);
    break;
  case A_notExp:
    printA_NotExp(out, e);
    break;
...
/* */
void printA_NewFloatArrExp(FILE *out, A_exp e) {
#ifdef __DEBUG
  fprintf(out, "Entering printA_NewFloatArrExp...\n");
#endif
  if (!e) return;
  if (e->kind != A_newFloatArrExp) fprintf(out, "Not NewFloatArray Exp!\n");
  else {
    fprintf(out, "new float[");
    printA_Exp(out, e->u.e);
    fprintf(out, "]");
  }
  return;
...
/* */
void printA_Getnum(FILE *out, A_exp e) {
#ifdef __DEBUG
