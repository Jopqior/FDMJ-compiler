...
Tr_exp Tr_CallStm(string meth, Tr_exp thiz, Tr_exp methAddr, Tr_expList el, T_type type);
...
Tr_exp Tr_CallExp(string meth, Tr_exp thiz, Tr_exp methAddr, Tr_expList el, T_type type);
