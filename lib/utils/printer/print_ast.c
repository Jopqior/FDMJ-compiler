...
/* */
void printX_Type(FILE *out, A_type t) {
#ifdef __DEBUG
...
/* */
void printX_VarDecl(FILE *out, A_varDecl vd) {
#ifdef __DEBUG
...
/* */
void printX_VarDeclList(FILE *out, A_varDeclList vdl) {
#ifdef __DEBUG
  ...
  fprintf(out, "</varDecl>\n");
  if (vdl->tail) printX_VarDeclList(out, vdl->tail);
  fprintf(out, "</varDeclList>\n");
  return ;
}

/* */
void printX_ClassDecl(FILE *out, A_classDecl cd) {
#ifdef __DEBUG
...
/* */
void printX_ClassDeclList(FILE *out, A_classDeclList cdl) {
#ifdef __DEBUG
  ...
  if (cdl->tail) printX_ClassDeclList(out, cdl->tail);
  fprintf(out, "</classDeclList>\n");
  return ;
}

/* */
void printX_MethodDecl(FILE* out, A_methodDecl md) {
#ifdef __DEBUG
 ...
 // fprintf(out, "public ");
  ...
  fprintf(out, "</name>\n");
  //fprintf(out, "(");
  if (md->fl) printX_FormalList(out, md->fl);
  //fprintf(out, ") {\n");
  if (md->vdl) printX_VarDeclList(out, md->vdl);
  if (md->sl) printX_StmList(out, md->sl);
  return;
}

/* */
void printX_MethodDeclList(FILE *out, A_methodDeclList mdl) {
#ifdef __DEBUG
  ...
  if (mdl->tail) printX_MethodDeclList(out, mdl->tail);
  fprintf(out, "</methodDeclList>\n");
  return;
}

/* */
void printX_Formal(FILE *out, A_formal f) {
#ifdef __DEBUG
...
/* */
void printX_FormalList(FILE *out, A_formalList fl) {
#ifdef __DEBUG
...
/* */
void printX_NestedStm(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_IfStm(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_WhileStm(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_ArrayInit(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_CallStm(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_Continue(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_Break(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_Return(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_Putnum(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_Putarray(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_Starttime(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_Stoptime(FILE *out, A_stm s) {
#ifdef __DEBUG
...
/* */
void printX_ExpList(FILE *out, A_expList el) {
#ifdef __DEBUG
...
/* */
void printX_ArrayExp(FILE *out, A_exp e) {
#ifdef __DEBUG
  fprintf(out, "Entering printX_OpExp...\n");
#endif
  if (!e) return;
...
/* */
void printX_CallExp(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_ClassVarExp(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_BoolConst(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_LengthExp(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_ThisExp(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_NewIntArrExp(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_NewFloatArrExp(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_NewObjExp(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_NotExp(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_Getnum(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_Getch(FILE *out, A_exp e) {
#ifdef __DEBUG
...
/* */
void printX_Getarray(FILE *out, A_exp e) {
#ifdef __DEBUG
